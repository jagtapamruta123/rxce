...
class SpareBody extends StatefulWidget {
  @override
  _SpareBodyState createState() => _SpareBodyState();
}

class _SpareBodyState extends State<SpareBody> with TickerProviderStateMixin {
